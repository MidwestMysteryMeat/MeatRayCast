...
return function(t)
    ...
    local JUNK = {
        '', '\1', '\1\1', '\1\2\0\0\0',                 -- truncated, wrong version
        '\1\1\255',                                     -- a varint that never ends
        string.char(1, 1, 0, 0, 200),                   -- 200 entities, five bytes
        string.char(1, 1, 0, 200, 0),                   -- 200 strings, five bytes
        string.char(1, 1, 0, 0, 1, 1, 255),             -- an entity with junk flags
        string.char(1, 1, 0, 0, 1, 1, 1, 99),           -- a string ref with no entry
        string.char(1, 1, 0, 0, 1, 1, 16, 200),         -- 200 components, no bytes
        string.rep('\1', 64),
        string.rep(string.char(1, 1, 0, 0, 0), 4),      -- trailing bytes
    }
    ...
    local raised = not pcall(P.unpack, P.SNAPSHOT .. string.char(1, 1, 0, 0, 255))
    ...
    local hostile = P.SNAPSHOT .. string.char(1, 1, 0, 0) .. string.char(255, 255, 255, 127)
